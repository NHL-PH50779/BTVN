...
const LoginPage = () => {
    ...
    try {
        ...
        // Redirect sau khi lưu thành công, tránh alert trước
        ...
        // Nếu muốn thông báo, dùng toast thay vì alert
    ...
    return (
        <div style={styles.pageContainer}>
            <div style={styles.loginCard}>
                <h2 style={styles.title}><Link to="/auth/register">Đăng kí </Link></h2>
